                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <label class="radio-inline">
                                            <input type="radio" name="optionsRadiosInline" id="optionsRadiosInline1" value="Todos" checked="">Todos
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="optionsRadiosInline" id="optionsRadiosInline2" value="Especifico">Especifico
                                        </label>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <button class="btn btn-info">Fechar</button>
                                    </div>
                                </div>
                            </div>
                            <!-- /.row (nested) -->
