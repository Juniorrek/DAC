                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <%
                            ...
                            out.println("<li><a href=\"departamentos.jsp\" class\"active\"><i class=\"fa fa-building fa-fw\"></i> Departamentos</a></li>");
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <a href="departamentos_cadastrar.jsp" type="button" class="btn btn-success" style="margin-bottom: 10px;">Cadastrar novo</a>
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    <tr>
                                        <td>Matriz</td>
                                        <td>Centro</td>
                                        <td><a href="departamentos_editar.jsp" type="button" class="btn btn-info">Editar</a><button type="button" class="btn btn-danger" style="margin-left: 10px;">Exluir</button></td>
                                    </tr>
                                    <tr>
                                        <td>Zona C</td>
                                        <td>Litoral</td>
