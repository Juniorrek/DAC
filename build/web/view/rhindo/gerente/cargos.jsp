...
<body>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li><a href="/DAC/Cargos?action=select" class="active"><i class="fa fa-briefcase fa-fw"></i> Cargos</a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <a type="button" href="/DAC/Cargos?action=formInsert" class="btn btn-success" style="margin-bottom: 10px;">Cadastrar novo</a>
                                    ...
                                    <tbody>
                                        <c:forEach items="${cargos}" var="cargo">
                                            <tr>
                                                ...
                                                <td><a href="/DAC/Cargos?action=formUpdate&id=${cargo.id}" type="button" class="btn btn-info">Editar</a>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <!-- /.panel-heading -->
                            <div class="panel-body">
                                <form action ="/DAC/Cargos?action=insert" method="POST">
                                    <div class="row">
                                        <div class="col-lg-4">
                                    ...
                                    <div style="text-align: center;">
                                        <a href="/DAC/Cargos?action=select" type="submit" class="btn btn-danger">Cancelar</a>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <!-- /.panel-heading -->
                            <div class="panel-body">
                                <form action="/DAC/Cargos?action=update" method="POST">
                                    <div class="row">
    ...
    <script>
        function excluir(id) {
            $("#excluir").attr("href", "/DAC/Cargos?action=delete&id=" + id);
        }
