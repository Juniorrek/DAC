                                ...
                                <fieldset>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="form-group">
                                                <label>Número:</label>
                                                <input class="form-control"  value="${logado.getNumero()}" type="number" name="numero" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-5">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="departamento" ${logado.perfil == 'Gerente de RH' ? '' : 'disabled'}>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label>Cargo:</label>
                                                <select class="form-control" name="cargo" ${logado.perfil == 'Gerente de RH' ? '' : 'disabled'}>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label>Perfil:</label>
                                                <select class="form-control" name="perfil" ${logado.perfil == 'Gerente de RH' ? '' : 'disabled'}>
