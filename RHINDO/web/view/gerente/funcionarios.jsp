...
<body>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li><a href="/RHINDO/Funcionarios?action=select" class="active"><i class="fa fa-users fa-fw"></i> Funcionários</a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <a type="button" href="/RHINDO/Funcionarios?action=formInsert" class="btn btn-success" style="margin-bottom: 10px;">Cadastrar novo***</a>
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <c:forEach items="${funcionarios}" var="funcionario">
                                        <tr>
                                            ...
                                            <td><a href="/RHINDO/Funcionarios?action=formUpdate&cpf=${funcionario.cpf}" type="button" class="btn btn-info">Editar</a>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <!-- /.panel-heading -->
                            <div class="panel-body">
                                <form action ="/RHINDO/Funcionarios?action=insert" method="POST">
                                    <fieldset>
                                    ...
                                    <div style="text-align: center;">
                                        <a href="/RHINDO/Funcionarios?action=select" type="submit" class="btn btn-danger">Cancelar</a>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <!-- /.panel-heading -->
                            <div class="panel-body">
                                <form action ="/RHINDO/Funcionarios?action=update" method="POST">
                                    <fieldset>
                                        <legend>Dados pessoais</legend>
                                        <div class="row">
                                            <div class="col-lg-12">
    ...
    <script>
        function excluir(cpf) {
            $("#excluir").attr("href", "/RHINDO/Funcionarios?action=delete&cpf=" + cpf);
        }
